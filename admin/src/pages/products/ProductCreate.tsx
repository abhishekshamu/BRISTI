    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Add Product</h2>
            <p className="text-slate-500 dark:text-slate-400">Create a new product</p>
          </div>
        </div>
        <button
          type="submit"
